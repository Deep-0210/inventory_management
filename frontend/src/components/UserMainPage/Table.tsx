...
import { EditStockData } from '../../Types/Types';

// const PrintTable = ({ endPoint, deleteStock, reApiCall }: { endPoint: string, deleteStock: Function, reApiCall: number }) => {
const PrintTable = ({ endPoint, reApiCall, setData }: { endPoint: string, reApiCall: number, setData: React.Dispatch<React.SetStateAction<EditStockData>> }) => {

  // useEffect(() => {
  //   if (endPoint.length || reApiCall === 1) {
  //     console.log(reApiCall, 'reApiCall')
  //     console.log(endPoint, 'endPoint')
  //     getTableData()
  //   }
  //   // eslint-disable-next-line
  // }, [endPoint.length > 0, reApiCall])
                  ...
                  <TableRow key={i}>
                    ...
                    <TableCell scope="row" align="center" sx={{ border: 2, borderColor: 'white' }} >
                      <div className='flex justify-center w-max mx-auto'>
                        ...
                        <div className='ms-3'>
                          <Button placeholder={'delete'} color='red' id={e._id} onClick={(e) => deleteStock(e)}>Delete</Button>
                        </div>
                      </div>
                    </TableCell>
                  </TableRow>
